...
psql -v ON_ERROR_STOP=1 --username "\$POSTGRES_USER" --dbname "\$POSTGRES_DB" -c "GRANT ALL PRIVILEGES ON SCHEMA quest TO quest_svc;"
...
psql -v ON_ERROR_STOP=1 --username "\$POSTGRES_USER" --dbname "\$POSTGRES_DB" -c "GRANT ALL PRIVILEGES ON SCHEMA project TO project_svc;"
