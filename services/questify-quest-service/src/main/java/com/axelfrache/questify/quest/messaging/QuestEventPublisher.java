...
public class QuestEventPublisher {
  ...
  public void publishQuestCompleted(
      UUID userId, UUID questId, String questTitle, int xpEarned,
      String categoryName, Instant completedAt) {
    var event = new QuestCompletedEvent(userId, questId, questTitle, xpEarned, categoryName, completedAt);
